...
MainWindow::MainWindow(QWidget *parent)
  ...
  ui->ISABrowser->setText(
      tr("<h2>CPU Emulator ISA v0.1</h2>"
         ...
         " extern int simRand();"
         " <h3>ASM Prologue:</h3>"
         " MOVli [stack register] 32767<br>"
         " BL [ret register] main<br>"
         " EXIT<br><br>"
         " simRand:<br>"
         " RAND [arg0 register]<br>"
         " BR [ret register]<br><br>"
         " simFlush:<br>"
         " FLUSH<br>"
         " BR [ret register]<br><br>"
         " simBkpt:<br>"
         ...
         " BR [ret register]<br><br>"
         " simSetPixel:<br>"
         " MULi [tmp register] [arg1 register] 256<br>"
         " ADDi [tmp register] [tmp register] 32767<br>"
         " ADDi [tmp register] [tmp register] 1<br>"
         " ST [arg2 register] [tmp register] [arg0 register]<br>"
         " BR [ret register]<br>"
